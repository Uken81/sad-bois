...
export const ArticleSummaries: React.FC<{ articles: Article[]; isLatest: boolean }> = ({ articles, isLatest }) => {
  ...
  return (
    <>
      {articles.map((article) => {
        const { id, imgUrl, date, title } = article;
        ...
        return (
          <div
            ...
            <figure className="mt-2  max-h-72 w-full bg-base-300">
              <ImageWithLoading src={imgUrl} style={{ maxHeight: '18rem', width: '100%' }} />
            </figure>
            <div>
              <div className="h-24 md:h-32">
                ...
                <h3 className="card-title text-base text-primary lg:text-xl lg:leading-7">{capitaliseWords(title)}</h3>
              </div>
