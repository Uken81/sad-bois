  ...
  return (
    <>
      ...
      {standardLinks.map((link) => {
        ...
        return (
          <div className="flex flex-row items-center border-l-2 border-accent duration-500 hover:border-primary">
      ...
      <div
        className="border-l-2 border-accent pl-2 duration-500 hover:border-primary"
